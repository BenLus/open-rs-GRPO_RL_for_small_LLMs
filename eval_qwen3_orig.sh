...
BASE_MODEL_ARGS="pretrained=$MODEL,dtype=bfloat16,max_model_length=32768,gpu_memory_utilization=0.6,generation_parameters={max_new_tokens:32768,temperature:0.6,top_p:0.95}"
...
run_evaluation() {
    ...
    output_dir="logs/evals/Qwen3_orig"
    ...
    echo "----------------------------------------"
    echo "Running evaluations for Qwen3 original model"
